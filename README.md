# В моей репозитории сильно изменён бейзлайн и добавлено много новых файлов

> **ВАЖНО:** Я использовал Python 3.13 для всего проекта, но ради этого пришлось использовать чужой lightfm из гитхаба.
```bash
# Команда для установки того LightFM.
